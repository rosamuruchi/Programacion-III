...
class Usuario
{
    ...
    public function cargarUsuario($file, $response)
    {
        if((Usuario::ValidarLegajo($_POST["legajo"],$file))!=-1)
        {
            ...
            $newResponse = $response->withJson('El Usuario se cargo exitosamente', 200);
    ...
    public static function validarUsuarios($legajo,$clave, $file,$response)
    {
     ...
     function modificarUsuario($file, $response)
    {
        $usuarios= Usuario::ConstruirUsuarios($file);
        ...
        if($index!= -1)
        {
            ...
            $newResponse = $response->withJson('Se modifico el Usuario.', 200);
...
public static function mostrarUsuarios($file,$legajo,$response)
{
    ...
    else
    {
        /*$respuesta = [ 'respuesta' => 'No existe usuario con ese Legajo'];
        echo json_encode($respuesta);*/
        $newResponse = $response->withJson("No existe usuario con ese Legajo", 200);
